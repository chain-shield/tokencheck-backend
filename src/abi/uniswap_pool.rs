...
pub mod uniswap_v3_pool {
    ...
    pub static UNISWAP_V3_POOL_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> UNISWAP_V3_POOL<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, UNISWAP_V3_POOLEvents>
        {
            self.0
    ...
    impl ::ethers::contract::EthLogDecode for UNISWAP_V3_POOLEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = IncreaseObservationCardinalityNextFilter::decode_log(log) {
                return Ok(
                    UNISWAP_V3_POOLEvents::IncreaseObservationCardinalityNextFilter(decoded),
                );
            }
    ...
    impl ::core::convert::From<IncreaseObservationCardinalityNextFilter> for UNISWAP_V3_POOLEvents {
    ...
    impl ::core::convert::From<IncreaseObservationCardinalityNextCall> for UNISWAP_V3_POOLCalls {

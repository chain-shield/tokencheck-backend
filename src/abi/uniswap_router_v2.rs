...
pub mod uniswap_v2_router {
    ...
    pub static UNISWAP_V2_ROUTER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl ::core::convert::From<RemoveLiquidityETHWithPermitCall> for UNISWAP_V2_ROUTERCalls {
    ...
    impl ::core::convert::From<RemoveLiquidityWithPermitCall> for UNISWAP_V2_ROUTERCalls {

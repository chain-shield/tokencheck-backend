...
pub struct ValidateApiKeyMiddleware {
    auth_service_api_keys: Rc<Vec<String>>,
}

impl ValidateApiKeyMiddleware {
    pub fn new(keys: Vec<String>) -> Self {
        ValidateApiKeyMiddleware {
            auth_service_api_keys: Rc::new(keys),
        }
    }
}
    ...
    B: actix_web::body::MessageBody + 'static,
{
    ...
    fn new_transform(&self, service: S) -> Self::Future {
        ok(ValidateApiKeyMiddlewareService {
            ...
            auth_service_api_keys: self.auth_service_api_keys.clone(),
        })
    }
}
